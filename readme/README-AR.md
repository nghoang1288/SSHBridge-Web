...
SSHBridge هي منصة مفتوحة المصدر ومجانية للأبد وذاتية الاستضافة لإدارة الخوادم بشكل شامل. توفر حلاً متعدد المنصات لإدارة خوادمك وبنيتك التحتية من خلال واجهة واحدة وسهلة الاستخدام. يوفر SSHBridge الوصول إلى طرفية SSH، والتحكم في سطح المكتب البعيد (RDP، VNC، Telnet)، وقدرات إنشاء أنفاق SSH، وإدارة ملفات SSH عن بُعد، والعديد من الأدوات الأخرى. يُعد SSHBridge البديل المثالي المجاني وذاتي الاستضافة لـ Termius المتاح لجميع المنصات.
...
- **دعم المنصات** - متاح كتطبيق ويب، وتطبيق سطح مكتب (Windows و Linux و macOS، يمكن تشغيله بشكل مستقل بدون خادم SSHBridge الخلفي)، و PWA، وتطبيق مخصص للهاتف المحمول/الجهاز اللوحي لـ iOS و Android.
...
راجع [المشاريع](https://github.com/nghoang1288/SSHBridge-Web) لعرض جميع الميزات المخططة. إذا كنت تتطلع للمساهمة، راجع [المساهمة](https://github.com/nghoang1288/SSHBridge-Web/blob/main/CONTRIBUTING.md).
...
قم بزيارة [وثائق](https://docs.termix.site/install) SSHBridge للحصول على مزيد من المعلومات حول كيفية تثبيت SSHBridge على جميع المنصات. بخلاف ذلك، يمكنك الاطلاع على نموذج ملف Docker Compose هنا (يمكنك حذف guacd والشبكة إذا كنت لا تخطط لاستخدام ميزات سطح المكتب البعيد):
...
إذا كنت بحاجة إلى مساعدة أو ترغب في طلب ميزة لـ SSHBridge، قم بزيارة صفحة [المشكلات](https://github.com/nghoang1288/SSHBridge-Web/issues)، وسجل الدخول، واضغط على `New Issue`.
