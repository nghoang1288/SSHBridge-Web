...
すべての予定機能については[Projects](https://github.com/nghoang1288/Termix)をご覧ください。コントリビュートをご希望の方は[Contributing](https://github.com/nghoang1288/Termix/blob/main/CONTRIBUTING.md)をご覧ください。
...
SSHBridgeに関するヘルプや機能リクエストが必要な場合は、[Issues](https://github.com/nghoang1288/Termix/issues)ページにアクセスし、ログインして`New Issue`を押してください。Issueはできるだけ詳細に記述し、英語での記述が望ましいです。また、[Discord](https://discord.gg/jVQGdvHDrf)サーバーに参加してサポートチャンネルを利用することもできますが、応答時間が長くなる場合があります。
