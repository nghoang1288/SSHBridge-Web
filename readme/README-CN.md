...
SSHBridge 是一个开源、永久免费、自托管的一体化服务器管理平台。它提供了一个多平台解决方案，通过一个直观的界面管理你的服务器和基础设施。SSHBridge 提供 SSH 终端访问、远程桌面控制（RDP、VNC、Telnet）、SSH 隧道功能、远程 SSH 文件管理以及许多其他工具。SSHBridge 是适用于所有平台的完美免费自托管 Termius 替代品。
...
- **数据库加密** - 后端存储为加密的 SQLite 数据库文件。查看[文档](https://github.com/nghoang1288/SSHBridge-Web#security-notes)了解更多。
...
- **语言** - 内置支持约 30 种语言（由 [Crowdin](https://github.com/nghoang1288/SSHBridge-Web/tree/main/src/locales) 管理）。
- **平台支持** - 提供 Web 应用、桌面应用（Windows、Linux 和 macOS，可脱离 SSHBridge 后端独立运行）、PWA 以及 iOS 和 Android 专用移动/平板应用。
...
查看 [Projects](https://github.com/nghoang1288/SSHBridge-Web) 了解所有计划功能。如果您想贡献代码，请参阅 [Contributing](https://github.com/nghoang1288/SSHBridge-Web/blob/main/CONTRIBUTING.md)。
...
访问 SSHBridge [文档](https://github.com/nghoang1288/SSHBridge-Web#readme) 了解有关如何在所有平台上安装 SSHBridge 的更多信息。此外，这里有一个示例 Docker Compose 文件（如果您不打算使用远程桌面功能，可以省略 guacd 和网络部分）：
...
如果您需要 SSHBridge 的帮助或想要请求功能，请访问 [Issues](https://github.com/nghoang1288/SSHBridge-Web/issues) 页面，登录并点击 `New Issue`。
