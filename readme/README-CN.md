...
查看 [Projects](https://github.com/nghoang1288/Termix) 了解所有计划功能。如果您想贡献代码，请参阅 [Contributing](https://github.com/nghoang1288/Termix/blob/main/CONTRIBUTING.md)。
...
如果您需要 SSHBridge 的帮助或想要请求功能，请访问 [Issues](https://github.com/nghoang1288/Termix/issues) 页面，登录并点击 `New Issue`。
