...
- **डेटाबेस एन्क्रिप्शन** - बैकएंड एन्क्रिप्टेड SQLite डेटाबेस फ़ाइलों के रूप में संग्रहीत। अधिक जानकारी के लिए [डॉक्स](https://github.com/nghoang1288/SSHBridge-Web#security-notes) देखें।
...
- **भाषाएँ** - लगभग 30 भाषाओं का बिल्ट-इन सपोर्ट ([Crowdin](https://github.com/nghoang1288/SSHBridge-Web/tree/main/src/locales) द्वारा प्रबंधित)।
...
सभी प्लेटफ़ॉर्म पर SSHBridge इंस्टॉल करने के बारे में अधिक जानकारी के लिए SSHBridge [डॉक्स](https://github.com/nghoang1288/SSHBridge-Web#readme) पर जाएँ। अन्यथा, यहाँ एक नमूना Docker Compose फ़ाइल देखें (यदि आप रिमोट डेस्कटॉप सुविधाओं का उपयोग करने की योजना नहीं बना रहे हैं तो आप guacd और नेटवर्क को हटा सकते हैं):
