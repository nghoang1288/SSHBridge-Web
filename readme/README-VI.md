...
Truy cập [Tài Liệu](https://docs.termix.site/install) SSHBridge để biết thêm thông tin về cách cài đặt SSHBridge trên tất cả các nền tảng. Ngoài ra, xem tệp Docker Compose mẫu tại đây (bạn có thể bỏ qua guacd và mạng nếu không có ý định sử dụng các tính năng điều khiển máy tính từ xa):
