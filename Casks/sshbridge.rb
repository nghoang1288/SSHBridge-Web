cask "sshbridge" do
  ...
  url "https://github.com/nghoang1288/Termix/releases/download/release-#{version}-tag/sshbridge_macos_universal_dmg.dmg"
  name "SSHBridge"
  desc "Web-based server management platform with SSH terminal, tunneling, and file editing"
  homepage "https://github.com/nghoang1288/Termix"
